<template>
	<view v-if="getRequestOK">
		...
		<uni-nav-bar backState="2000" fontColor="#FFF" :titleCenter="false" type="transparent">
			<view slot="left"><image class="hicon" src="/static/home.png" mode="aspectFit" @tap="goHome" /></view>
		</uni-nav-bar>
		...
		<!-- 资讯详情 -->
		<view class="info-content"><html-parse :content="newInfo.content" /></view>
...
import { getNewInfo } from '@/common/http.api.js';
...
export default {
	...
	async onLoad(options) {
		...
		// #endif
		let res = await getNewInfo(options);
