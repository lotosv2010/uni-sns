	...
	<view class="login" :class="{show:show}">
		...
		<view class="container">
			...
			<view v-show="!getUserInfoTag">
				...
				<view class="btns">
					<u-button class="ubtn" type="error" @click="submit">提交</u-button>
					<u-button class="ubtn" @click="cancel">取消</u-button>
				</view>
				<view class="type">
					<u-subsection :list="subsectionList" :current="curNow" @change="sectionChange"></u-subsection>
				</view>
			</u-form>
			</view>
...
<script>
	...
	import { findUser, getUserMsg, userRegister, userLogin, getLoginCode } from '@/common/http.api.js'
					...
					name: [{
							asyncValidator: async (rule, value, callback) => {
								...
								if (this.loginType === 'phone' || this.loginType === 'email') {
									let res = await findUser({ name: value })
